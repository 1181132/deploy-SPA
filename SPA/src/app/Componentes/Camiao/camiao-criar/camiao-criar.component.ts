...
constructor( private camiaoService: CamiaoService) { }
  ...
  add(tara: number,matricula: string,capacidadeCarga: number,cargaTotalBaterias: number,autonomiaCargaMax: number,tempoCarregamento20ate80:number): void {
       matricula = matricula.trim();
       if (!matricula) { return; }
       this.camiaoService.addCamiao({tara,matricula,capacidadeCarga,cargaTotalBaterias,autonomiaCargaMax,tempoCarregamento20ate80} as Camiao)
